    ...
    <div class="container">
        <div class="row centered">
            <div class="col-lg-12">
                ...
                <h3><a href="{{ url('/login') }}" class="btn btn-lg btn-success">Zaloguj się!</a></h3><br>
            </div>
        </div>
    </div> <!--/ .container -->
</div><!--/ #headerwrap -->
...
<div id="c">
    <div class="container">
        <p>
            <strong>Copyright &copy; {{ date('Y') }}. Powered by <a href="mailto:bartek.piatkowski@gmail.com"><b>Bartosz Piątkowski</b></a>
        </p>
    </div>
</div>
