...
<body class="hold-transition login-page">
    ...
    @if (count($errors) > 0)
        <div class="alert alert-danger">
            <strong>Uwaga!</strong> Twoje dane są nieprawidłowe.<br><br>
            <ul>
    ...
    <p class="login-box-msg">Wpisz dane aby się zalogować</p>
    ...
    <a href="{{ url('/password/reset') }}">Przypomnij hasło</a><br>
    <a href="{{ url('/register') }}" class="text-center">Zarejestruj się</a>
