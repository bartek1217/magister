		...
		<div class="navbar-custom-menu">
			<ul class="nav navbar-nav">
						...
						<ul class="dropdown-menu">
							...
							<li class="user-header">
								...
								<p>
									...
									?>
									<small>Zarejestrowany od: <?php echo date("m-Y", strtotime($datec)); ?></small>
								</p>
							</li>
							<!-- Menu Body -->
							@role("SUPER_ADMIN")
							...
							<li class="user-footer">
								<div class="pull-left">
									<a href="{{ url(config('laraadmin.adminRoute') . '/users/') .'/'. Auth::user()->id }}" class="btn btn-default btn-flat">Użytkownik</a>
								</div>
								<div class="pull-right">
									<a href="{{ url('/logout') }}" class="btn btn-default btn-flat">Wyloguj się</a>
								</div>
							</li>
						</ul>
					</li>
				...
				<li>
					<a href="#" data-toggle="control-sidebar"><i class="fa fa-gears"></i> <span class="label label-warning"></span></a>
